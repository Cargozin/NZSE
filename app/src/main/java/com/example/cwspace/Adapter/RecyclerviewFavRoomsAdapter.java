...
public class RecyclerviewFavRoomsAdapter extends RecyclerView.Adapter<RecyclerviewFavRoomsAdapter.RoomsViewHolder> implements Filterable {
    ...
    public RecyclerviewFavRoomsAdapter(Context context, ArrayList<Room> arrayRooms) {
        mContext = context;
